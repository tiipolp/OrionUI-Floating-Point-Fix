		...
		local function L_145_func(L_152_arg1)
			...
			function L_153_:AddSlider(L_175_arg1)
				...
				function L_176_:Set(L_182_arg1)
					...
					L_179_.Value.Text = string.format("%s %s", math.floor(L_182_arg1 * 10^(2 or 0) + 0.5) / 10^(2 or 0), L_175_arg1.ValueName)
					L_178_.Value.Text = string.format("%s %s", math.floor(L_182_arg1 * 10^(2 or 0) + 0.5) / 10^(2 or 0), L_175_arg1.ValueName)
