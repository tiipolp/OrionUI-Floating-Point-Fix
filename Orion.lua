...
if gethui then
	for L_36_forvar1, L_37_forvar2 in ipairs(gethui():GetChildren()) do
		if L_37_forvar2.Name == L_13_.Name and L_37_forvar2 ~= L_13_ then
			L_9_:AddItem(L_37_forvar2, 0)
		end
	end
else
	for L_38_forvar1, L_39_forvar2 in ipairs(L_8_:GetChildren()) do
...
local function L_24_func()
	for L_81_forvar1, L_82_forvar2 in pairs(L_10_.ThemeObjects) do
		for L_83_forvar1, L_84_forvar2 in pairs(L_82_forvar2) do
...
local function L_28_func(L_91_arg1)
	local L_92_ = {}
	for L_93_forvar1, L_94_forvar2 in pairs(L_10_.Flags) do
...
function L_10_:MakeWindow(L_135_arg1)
	...
	L_135_arg1.HideTester = L_135_arg1.HideTester or false
	...
	local L_144_ = L_23_func(L_20_func(L_19_func(L_18_func("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
		...
		L_20_func(L_19_func(L_18_func("TFrame"), {
			...
			L_23_func(L_19_func(L_18_func("Label", L_5_.DisplayName, L_135_arg1.HideTester and 14 or 13), {
				Size = UDim2.new(1, -60, 0, 13),
				Position = L_135_arg1.HideTester and UDim2.new(0, 50, 0, 19) or UDim2.new(0, 50, 0, 12),
				Font = Enum.Font.GothamBold,
			...
			L_23_func(L_19_func(L_18_func("Label", "", 12), {
				...
				Visible = not L_135_arg1.HideTester
			}), "TextDark")
		})
	}), "Second")
	...
	local function L_148_func()
		...
		L_3_:Create(L_152_, TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
			ImageTransparency = 0,
		...
		wait(0.3)
		L_3_:Create(L_153_, TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
			TextTransparency = 0
		}):Play()
		wait(2)
		L_3_:Create(L_153_, TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
	...
	function L_149_:MakeTab(L_154_arg1)
		...
		L_154_arg1.TesterOnly = L_154_arg1.TesterOnly or false
		...
		local function L_157_func(L_164_arg1)
			...
			function L_165_:AddSlider(L_187_arg1)
				...
				function L_188_:Set(L_197_arg1)
					...
					L_3_:Create(L_190_, TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
			...
			function L_165_:AddDropdown(L_198_arg1)
				...
				local function L_205_func(L_206_arg1)
					for L_207_forvar1, L_208_forvar2 in pairs(L_206_arg1) do
				...
				function L_199_:Refresh(L_210_arg1, L_211_arg2)
					if L_211_arg2 then
						for L_212_forvar1, L_213_forvar2 in pairs(L_199_.Buttons) do
				...
				function L_199_:Set(L_214_arg1)
					if not table.find(L_199_.Options, L_214_arg1) then
						...
						for L_215_forvar1, L_216_forvar2 in pairs(L_199_.Buttons) do
							L_3_:Create(L_216_forvar2, TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
								BackgroundTransparency = 1
							}):Play()
							L_3_:Create(L_216_forvar2.Title, TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
								TextTransparency = 0.4
							}):Play()
						end
						return
					...
					L_204_.F.Selected.Text = L_199_.Value
					for L_217_forvar1, L_218_forvar2 in pairs(L_199_.Buttons) do
						L_3_:Create(L_218_forvar2, TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
							BackgroundTransparency = 1
						}):Play()
						L_3_:Create(L_218_forvar2.Title, TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
							TextTransparency = 0.4
						}):Play()
					end
					L_3_:Create(L_199_.Buttons[L_214_arg1], TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						BackgroundTransparency = 0
					}):Play()
					L_3_:Create(L_199_.Buttons[L_214_arg1].Title, TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						TextTransparency = 0
					}):Play()
				...
				L_14_func(L_203_.MouseButton1Click, function()
					...
					L_3_:Create(L_204_.F.Ico, TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						Rotation = L_199_.Toggled and 180 or 0
					}):Play()
					if #L_199_.Options > L_200_ then
						L_3_:Create(L_204_, TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
			...
			function L_165_:AddColorpicker(L_235_arg1)
				...
				L_14_func(L_245_.MouseButton1Click, function()
					...
					L_3_:Create(L_247_, TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
